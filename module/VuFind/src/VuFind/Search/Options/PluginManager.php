...
class PluginManager extends \VuFind\ServiceManager\AbstractPluginManager
{
    ...
    protected $aliases = [
        ...
        'semanticsearch' => \VuFind\Search\SemanticSearch\Options::class,
        'hybridsearch' => \VuFind\Search\HybridSearch\Options::class,
    ...
    protected $factories = [
        ...
        \VuFind\Search\SemanticSearch\Options::class => OptionsFactory::class,
        \VuFind\Search\HybridSearch\Options::class => OptionsFactory::class,
