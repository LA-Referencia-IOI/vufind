...
/**
 * SemanticSearchFactory Test Class
 *
 * PHP version 8
 *
 * @category VuFind
 ...
 * @package  Tests
 */
class SemanticSearchFactoryTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    public function testFactoryRejectsUnexpectedOptions(): void
    {
        ...
        $factory = new SemanticSearchFactory();

        $this->expectException(\Exception::class);
        $this->expectExceptionMessage('Unexpected options passed to factory.');
        $factory($container, SemanticSearch::class, ['unexpected']);
    }
    ...
    public function testFactoryCreatesDriver(): void
    {
        ...
        $factory = new SemanticSearchFactory();
        $result = $factory($container, SemanticSearch::class);
        $this->assertInstanceOf(SemanticSearch::class, $result);
    }
}
